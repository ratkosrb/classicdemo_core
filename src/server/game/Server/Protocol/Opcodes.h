...
enum OpcodeClient : uint16
{
    ...
    CMSG_CALENDAR_GUILD_FILTER                        = 0x366F,
    ...
    CMSG_GET_UNDELETE_CHARACTER_COOLDOWN_STATUS       = 0xBADD, //0x36DC, // new value
    ...
    CMSG_LFG_LIST_UPDATE_REQUEST                      = 0x3346, // Can't find at 1.13.0 TODO
    ...
    //CMSG_PET_BATTLE_INPUT                             = 0x3640, // Not exist at 1.13
    ...
    CMSG_QUERY_GARRISON_CREATURE_NAME                 = 0x327C,
    ...
    CMSG_QUERY_PAGE_TEXT                              = 0x3269,
    CMSG_QUERY_PETITION                               = 0x326A,
    CMSG_QUERY_PET_NAME                               = 0x3263, //todo 
    ...
    //CMSG_QUERY_SCENARIO_POI                           = 0x3655, // Not exist in 1.13
    ...
    //CMSG_QUEST_POI_QUERY                              = 0x , // Not exist in 1.13 
    ...
    CMSG_SET_ACTION_BUTTON                            = 0x363F, //new 1.13
    ...
    //CMSG_SHOW_TRADE_SKILL                             = 0x0, // Not exist 1.13
...
enum OpcodeServer : uint16
{
    ...
    SMSG_LOAD_SELECTED_TROPHY_RESULT                  = 0xBADD, //temp disabled
    ...
    SMSG_REALM_QUERY_RESPONSE                         = 0x26DF, //
