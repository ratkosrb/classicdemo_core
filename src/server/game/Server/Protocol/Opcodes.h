...
enum OpcodeClient : uint16
{
    ...
    CMSG_ADD_BATTLENET_FRIEND                         = 0x3658, // new value 1.13
    CMSG_ADD_FRIEND                                   = 0x36CC, // new value
    CMSG_ADD_IGNORE                                   = 0x36D0, // new value
    CMSG_ADD_TOY                                      = 0x328E, // new value
    CMSG_ADVENTURE_JOURNAL_OPEN_QUEST                 = 0x31F9,
    CMSG_ADVENTURE_JOURNAL_START_QUEST                = 0x332E, // todo not eist?
    CMSG_ALTER_APPEARANCE                             = 0x34F9,
    CMSG_AREA_SPIRIT_HEALER_QUERY                     = 0x34B3,
    CMSG_AREA_SPIRIT_HEALER_QUEUE                     = 0x34B4,
    CMSG_AREA_TRIGGER                                 = 0x31D0, // new value
    CMSG_ARTIFACT_ADD_POWER                           = 0x31A8, // new value
    ...
    CMSG_ASSIGN_EQUIPMENT_SET_SPEC                    = 0x3203, // new value
    CMSG_ATTACK_STOP                                  = 0x3250, // new value
    CMSG_ATTACK_SWING                                 = 0x324F, // new value
    ...
    CMSG_BATTLEFIELD_LEAVE                            = 0x3174, // new value
    CMSG_BATTLEFIELD_LIST                             = 0x3180, // new value
    CMSG_BATTLEFIELD_PORT                             = 0x3529,
    CMSG_BATTLEMASTER_HELLO                           = 0x32A4, // new value
    CMSG_BATTLEMASTER_JOIN                            = 0x3524,
    CMSG_BATTLEMASTER_JOIN_ARENA                      = 0x3525, // todo not exist ?
    CMSG_BATTLEMASTER_JOIN_BRAWL                      = 0x3527,
    CMSG_BATTLEMASTER_JOIN_SKIRMISH                   = 0x3526,
    CMSG_BATTLENET_CHALLENGE_RESPONSE                 = 0x36CF, // new value
    CMSG_BATTLENET_REQUEST                            = 0x36F3, // new value
    CMSG_BATTLENET_REQUEST_REALM_LIST_TICKET          = 0x36F4, // new value
    CMSG_BATTLE_PAY_ACK_FAILED_RESPONSE               = 0x36C7, // new value
    CMSG_BATTLE_PAY_CONFIRM_PURCHASE_RESPONSE         = 0x36C6, // new value
    CMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_TO_TARGET     = 0x36BD, // new value
    CMSG_BATTLE_PAY_GET_PRODUCT_LIST                  = 0x36B7, //
    CMSG_BATTLE_PAY_GET_PURCHASE_LIST                 = 0x36B8, //
    CMSG_BATTLE_PAY_QUERY_CLASS_TRIAL_BOOST_RESULT    = 0x36C0, // new value
    CMSG_BATTLE_PAY_REQUEST_CHARACTER_BOOST_UNREVOKE  = 0x36BE, // new value
    CMSG_BATTLE_PAY_REQUEST_CURRENT_VAS_TRANSFER_QUEUES = 0x3705, // new value
    CMSG_BATTLE_PAY_REQUEST_PRICE_INFO                = 0x3704, // new value
    CMSG_BATTLE_PAY_REQUEST_VAS_CHARACTER_QUEUE_TIME  = 0x3709,
    CMSG_BATTLE_PAY_START_PURCHASE                    = 0x36EF, // new value
    CMSG_BATTLE_PAY_START_VAS_PURCHASE                = 0x36F0, // new value
    CMSG_BATTLE_PAY_TRIAL_BOOST_CHARACTER             = 0x36BF, // new value
    CMSG_BATTLE_PAY_VALIDATE_BNET_VAS_TRANSFER        = 0x3707, // new value
    ...
    CMSG_BUG_REPORT                                   = 0x3684, // new value
    CMSG_BUSY_TRADE                                   = 0x3158, //
    CMSG_BUY_BACK_ITEM                                = 0x34A7,
    CMSG_BUY_BANK_SLOT                                = 0x34B7,
    CMSG_BUY_ITEM                                     = 0x34A6, //
    CMSG_BUY_REAGENT_BANK                             = 0x34B8,
    CMSG_BUY_WOW_TOKEN_CONFIRM                        = 0x36E8, // new value
    CMSG_BUY_WOW_TOKEN_START                          = 0x36E7, // new value
    CMSG_CAGE_BATTLE_PET                              = 0x31EB, // new value
    CMSG_CALENDAR_ADD_EVENT                           = 0x367B, // new value
    CMSG_CALENDAR_COMPLAIN                            = 0x3677, // new value
    CMSG_CALENDAR_COPY_EVENT                          = 0x3676, // new value
    CMSG_CALENDAR_EVENT_INVITE                        = 0x3670, //
    CMSG_CALENDAR_EVENT_MODERATOR_STATUS              = 0x3674, // new value
    CMSG_CALENDAR_EVENT_RSVP                          = 0x3672, // new value
    CMSG_CALENDAR_EVENT_SIGN_UP                       = 0x3679, // new value
    CMSG_CALENDAR_EVENT_STATUS                        = 0x3673, // new value
    CMSG_CALENDAR_GET                                 = 0x366D, // new value
    CMSG_CALENDAR_GET_EVENT                           = 0x366E, // new value
    CMSG_CALENDAR_GET_NUM_PENDING                     = 0x3678, // new value
    CMSG_CALENDAR_GUILD_FILTER                        = 0x366F, // new value
    CMSG_CALENDAR_REMOVE_EVENT                        = 0x3675, // new value
    CMSG_CALENDAR_REMOVE_INVITE                       = 0x3671, // new value
    CMSG_CALENDAR_UPDATE_EVENT                        = 0x367C, // new value
    CMSG_CANCEL_AURA                                  = 0x31AC,
    CMSG_CANCEL_AUTO_REPEAT_SPELL                     = 0x34EB,
    CMSG_CANCEL_CAST                                  = 0x3294, // new value
    CMSG_CANCEL_CHANNELLING                           = 0x325F, // new value
    CMSG_CANCEL_GROWTH_AURA                           = 0x3264, // new value
    CMSG_CANCEL_MASTER_LOOT_ROLL                      = 0x320B, // new value
    CMSG_CANCEL_MOD_SPEED_NO_CONTROL_AURAS            = 0x31AB,
    CMSG_CANCEL_MOUNT_AURA                            = 0x3275, // new value
    CMSG_CANCEL_QUEUED_SPELL                          = 0x3181, // new value
    CMSG_CANCEL_TEMP_ENCHANTMENT                      = 0x34F6,
    CMSG_CANCEL_TRADE                                 = 0x315C, //
    CMSG_CAN_DUEL                                     = 0x3660, // new opcode value
    CMSG_CAN_REDEEM_WOW_TOKEN_FOR_BALANCE             = 0x3703, // new value
    CMSG_CAST_SPELL                                   = 0x3291, // new value
    CMSG_CHALLENGE_MODE_REQUEST_LEADERS               = 0x308F,
    CMSG_CHALLENGE_MODE_REQUEST_MAP_STATS             = 0x308E,
    CMSG_CHANGE_BAG_SLOT_FLAG                         = 0x3315, // new value
    CMSG_CHANGE_MONUMENT_APPEARANCE                   = 0x32F4,
    CMSG_CHANGE_SUB_GROUP                             = 0x364B, // new value
    CMSG_CHARACTER_RENAME_REQUEST                     = 0x36BB, // new value
    CMSG_CHAR_CUSTOMIZE                               = 0x368C, // new value
    CMSG_CHAR_DELETE                                  = 0x3699, // new value
    CMSG_CHAR_RACE_OR_FACTION_CHANGE                  = 0x3692, // new value
    //CliChatEntity - all opcodes are same as legion
    ...
    //
    CMSG_CHECK_RAF_EMAIL_ENABLED                      = 0x36C8, // new value
    CMSG_CHECK_WOW_TOKEN_VETERAN_ELIGIBILITY          = 0x36E6, // new value
    CMSG_CHOICE_RESPONSE                              = 0x3296, // new value
    ...
    CMSG_COMPLAINT                                    = 0x366A, // new value 1.13
    CMSG_COMPLETE_CINEMATIC                           = 0x3549, //
    CMSG_COMPLETE_MOVIE                               = 0x34E1,
    CMSG_CONFIRM_ARTIFACT_RESPEC                      = 0x31A6,
    CMSG_CONFIRM_RESPEC_WIPE                          = 0x3205, // new value
    CMSG_CONNECT_TO_FAILED                            = 0x35D4, //
    CMSG_CONTRIBUTION_CONTRIBUTE                      = 0x3559, // new value
    CMSG_CONTRIBUTION_GET_STATE                       = 0x355A, // new value
    CMSG_CONVERSATION_LINE_STARTED                    = 0x354A,
    CMSG_CONVERT_CONSUMPTION_TIME                     = 0x36F6, // new value
    CMSG_CONVERT_RAID                                 = 0x364D, // new value
    CMSG_CREATE_CHARACTER                             = 0x3642, // new value 1.13
    CMSG_CREATE_SHIPMENT                              = 0x32E3, // new value
    CMSG_DB_QUERY_BULK                                = 0x35E4, //
    CMSG_DECLINE_GUILD_INVITES                        = 0x3522,
    CMSG_DECLINE_PETITION                             = 0x3538,
    CMSG_DELETE_EQUIPMENT_SET                         = 0x3510,
    CMSG_DEL_FRIEND                                   = 0x36CD, // new value
    CMSG_DEL_IGNORE                                   = 0x36D1, // new value
    CMSG_DEPOSIT_REAGENT_BANK                         = 0x331E, // new value
    CMSG_DESTROY_ITEM                                 = 0x3288, // new value
    ...
    CMSG_DO_MASTER_LOOT_ROLL                          = 0x320A, // new value
    CMSG_DO_READY_CHECK                               = 0x3633, //
    CMSG_DUEL_RESPONSE                                = 0x34E6,
    CMSG_EJECT_PASSENGER                              = 0x3233, // new value
    CMSG_EMOTE                                        = 0x3545, //
    CMSG_ENABLE_ENCRYPTION_ACK                        = 0x3767, //
    CMSG_ENABLE_NAGLE                                 = 0x376B, //
    CMSG_ENABLE_TAXI_NODE                             = 0x34AC,
    CMSG_ENGINE_SURVEY                                = 0x36E0, // new value
    CMSG_ENUM_CHARACTERS                              = 0x35E8, //
    CMSG_ENUM_CHARACTERS_DELETED_BY_CLIENT            = 0x36DA, // new value
    ...
    CMSG_GARRISON_REQUEST_LANDING_PAGE_SHIPMENT_INFO  = 0x32E2, // new value
    ...
    CMSG_GET_CHALLENGE_MODE_REWARDS                   = 0x3681, // new value
    CMSG_GET_GARRISON_INFO                            = 0x32B5, // new value
    CMSG_GET_ITEM_PURCHASE_DATA                       = 0x3533,
    CMSG_GET_MIRROR_IMAGE_DATA                        = 0x328C, // new value
    CMSG_GET_PVP_OPTIONS_ENABLED                      = 0x35EE,
    CMSG_GET_REMAINING_GAME_TIME                      = 0x36E9,
    CMSG_GET_TROPHY_LIST                              = 0x32F4, // new value
    CMSG_GET_UNDELETE_CHARACTER_COOLDOWN_STATUS       = 0x36DC, // new value
    CMSG_GM_TICKET_ACKNOWLEDGE_SURVEY                 = 0x3690, // new value
    CMSG_GM_TICKET_GET_CASE_STATUS                    = 0x368F, // new value
    CMSG_GM_TICKET_GET_SYSTEM_STATUS                  = 0x368E, // new value
    ...
    CMSG_GUILD_SET_GUILD_MASTER                       = 0x36C2, // new value
    ...
    CMSG_ITEM_TEXT_QUERY                              = 0x3312, // new value
    CMSG_JOIN_PET_BATTLE_QUEUE                        = 0x31D4,
    CMSG_JOIN_RATED_BATTLEGROUND                      = 0x3179, // new value
    CMSG_KEEP_ALIVE                                   = 0x367D, // new value
    CMSG_KEYBOUND_OVERRIDE                            = 0x321C, // new value
    CMSG_LEARN_PVP_TALENTS                            = 0x3558, // new value
    CMSG_LEARN_TALENTS                                = 0x3557, // new value
    ...
    CMSG_LFG_LIST_JOIN                                = 0x3348, // new value
    CMSG_LFG_LIST_LEAVE                               = 0x3609, //
    CMSG_LFG_LIST_SEARCH                              = 0x360B,
    CMSG_LFG_LIST_UPDATE_REQUEST                      = 0x3349, // new value
    ...
    CMSG_LOAD_SELECTED_TROPHY                         = 0x32F5, // new value
    ...
    CMSG_LOOT_ITEM                                    = 0x3208, // new value
    CMSG_LOOT_MONEY                                   = 0x3207, // new value
    CMSG_LOOT_RELEASE                                 = 0x320C, // new value
    CMSG_LOOT_ROLL                                    = 0x320D, // new value
    CMSG_LOOT_UNIT                                    = 0x3206, // new value
    CMSG_LOW_LEVEL_RAID1                              = 0x369D, // new value
    CMSG_LOW_LEVEL_RAID2                              = 0x3518,
    CMSG_MAIL_CREATE_TEXT_ITEM                        = 0x353F,
    CMSG_MAIL_DELETE                                  = 0x321E, // new value
    CMSG_MAIL_GET_LIST                                = 0x353A, //
    CMSG_MAIL_MARK_AS_READ                            = 0x353E,
    CMSG_MAIL_RETURN_TO_SENDER                        = 0x3654, // new value
    CMSG_MAIL_TAKE_ITEM                               = 0x353C,
    CMSG_MAIL_TAKE_MONEY                              = 0x353B,
    CMSG_MASTER_LOOT_ITEM                             = 0x3209, // new value
    CMSG_MINIMAP_PING                                 = 0x364A, // new value
    CMSG_MISSILE_TRAJECTORY_COLLISION                 = 0x318C, // new value
    CMSG_MOUNT_CLEAR_FANFARE                          = 0x312D,
    CMSG_MOUNT_SET_FAVORITE                           = 0x3631, //
    CMSG_MOUNT_SPECIAL_ANIM                           = 0x3276, // new value
    ...
    CMSG_NEUTRAL_PLAYER_SELECT_FACTION                = 0x31CD, // new value
    CMSG_NEXT_CINEMATIC_CAMERA                        = 0x3548, //
    CMSG_OBJECT_UPDATE_FAILED                         = 0x3182, // new value
    CMSG_OBJECT_UPDATE_RESCUED                        = 0x3183, // new value
    CMSG_OFFER_PETITION                               = 0x36AD, //
    CMSG_OPENING_CINEMATIC                            = 0x3547, //
    CMSG_OPEN_ITEM                                    = 0x3313, // new value
    CMSG_OPEN_MISSION_NPC                             = 0x32D7,
    CMSG_OPEN_SHIPMENT_NPC                            = 0x32DD,
    CMSG_OPEN_TRADESKILL_NPC                          = 0x32EB, // new value
    CMSG_OPT_OUT_OF_LOOT                              = 0x34FA,
    CMSG_PARTY_INVITE                                 = 0x3602, //
    CMSG_PARTY_INVITE_RESPONSE                        = 0x3603, //
    CMSG_PARTY_UNINVITE                               = 0x3646, // new value 1.13
    CMSG_PETITION_BUY                                 = 0x34CD,
    CMSG_PETITION_RENAME_GUILD                        = 0x36C3, // new value
    ...
    CMSG_PET_BATTLE_INPUT                             = 0x363F, // new value
    ...
    CMSG_PET_CAST_SPELL                               = 0x3290, // new value
    CMSG_PET_RENAME                                   = 0x3683, // new value
    ...
    CMSG_PVP_LOG_DATA                                 = 0x317D, // new value
    CMSG_PVP_PRESTIGE_RANK_UP                         = 0x3335, // new value
    CMSG_QUERY_BATTLE_PET_NAME                        = 0x326B, // new value
    CMSG_QUERY_CORPSE_LOCATION_FROM_CLIENT            = 0x365E, // new value 
    CMSG_QUERY_CORPSE_TRANSPORT                       = 0x365F, // new value
    CMSG_QUERY_COUNTDOWN_TIMER                        = 0x31A7, // new value
    CMSG_QUERY_CREATURE                               = 0x3265, // new value
    CMSG_QUERY_GAME_OBJECT                            = 0x3266, // new value
    CMSG_QUERY_GARRISON_CREATURE_NAME                 = 0x326C, // new value
    CMSG_QUERY_GUILD_INFO                             = 0x368B, // new value
    CMSG_QUERY_INSPECT_ACHIEVEMENTS                   = 0x3506,
    CMSG_QUERY_NEXT_MAIL_TIME                         = 0x353D,
    CMSG_QUERY_NPC_TEXT                               = 0x3267, // new value
    CMSG_QUERY_PAGE_TEXT                              = 0x3269, // new value
    CMSG_QUERY_PETITION                               = 0x326D, // new value
    CMSG_QUERY_PET_NAME                               = 0x326A, // new value 
    CMSG_QUERY_PLAYER_NAME                            = 0x3689, // new value
    CMSG_QUERY_QUEST_COMPLETION_NPCS                  = 0x3176, // new value
    CMSG_QUERY_QUEST_INFO                             = 0x3268, // new value
    CMSG_QUERY_QUEST_REWARDS                          = 0x3339, // new value
    CMSG_QUERY_REALM_NAME                             = 0x368A, // new value
    CMSG_QUERY_TIME                                   = 0x34DA, //
    CMSG_QUERY_VOID_STORAGE                           = 0x31A0, // new value
    ...
    CMSG_QUICK_JOIN_AUTO_ACCEPT_REQUESTS              = 0x3702, // new value
    CMSG_QUICK_JOIN_REQUEST_INVITE                    = 0x3701, // new value
    CMSG_QUICK_JOIN_RESPOND_TO_INVITE                 = 0x3700, // new value
    CMSG_QUICK_JOIN_SIGNAL_TOAST_DISPLAYED            = 0x36FF, // new value
    CMSG_RAID_OR_BATTLEGROUND_ENGINE_SURVEY           = 0x36E1, // new value
    CMSG_RANDOM_ROLL                                  = 0x3653, // new value
    CMSG_READY_CHECK_RESPONSE                         = 0x3634, //
    CMSG_READ_ITEM                                    = 0x3314, // new value
    CMSG_RECLAIM_CORPSE                               = 0x34DF,
    CMSG_RECRUIT_A_FRIEND                             = 0x36C9, // new value
    CMSG_REDEEM_WOW_TOKEN_CONFIRM                     = 0x36EB, // new value
    CMSG_REDEEM_WOW_TOKEN_START                       = 0x36EA, // new value
    CMSG_REMOVE_NEW_ITEM                              = 0x333C, // new value
    CMSG_REORDER_CHARACTERS                           = 0x35E9, //
    CMSG_REPAIR_ITEM                                  = 0x34F0, //
    CMSG_REPLACE_TROPHY                               = 0x32F6, // new value
    CMSG_REPOP_REQUEST                                = 0x352A,
    CMSG_REPORT_CLIENT_VARIABLES                      = 0x36FC, // new value
    CMSG_REPORT_ENABLED_ADDONS                        = 0x36FB, // new value
    CMSG_REPORT_KEYBINDING_EXECUTION_COUNTS           = 0x36FD, // new value
    CMSG_REPORT_PVP_PLAYER_AFK                        = 0x34F8,
    CMSG_REQUEST_ACCOUNT_DATA                         = 0x3693, // new value
    CMSG_REQUEST_AREA_POI_UPDATE                      = 0x3338,
    CMSG_REQUEST_BATTLEFIELD_STATUS                   = 0x35DC, //
    CMSG_REQUEST_CATEGORY_COOLDOWNS                   = 0x317F, // new value
    CMSG_REQUEST_CEMETERY_LIST                        = 0x3177, // new value
    CMSG_REQUEST_CONQUEST_FORMULA_CONSTANTS           = 0x32A7, // new value
    CMSG_REQUEST_CONSUMPTION_CONVERSION_INFO          = 0x36F5, // new value
    CMSG_REQUEST_CROWD_CONTROL_SPELL                  = 0x352E,
    CMSG_REQUEST_FORCED_REACTIONS                     = 0x3201, // new value
    CMSG_REQUEST_GUILD_PARTY_STATE                    = 0x31A3,
    CMSG_REQUEST_GUILD_REWARDS_LIST                   = 0x31A2,
    CMSG_REQUEST_HONOR_STATS                          = 0x317C, // new value
    CMSG_REQUEST_LFG_LIST_BLACKLIST                   = 0x3298, // new value
    CMSG_REQUEST_PARTY_JOIN_UPDATES                   = 0x35F7, //
    CMSG_REQUEST_PARTY_MEMBER_STATS                   = 0x3652, //
    CMSG_REQUEST_PET_INFO                             = 0x3493,
    CMSG_REQUEST_PLAYED_TIME                          = 0x3270, // new value
    CMSG_REQUEST_PVP_BRAWL_INFO                       = 0x3194, // new value
    CMSG_REQUEST_PVP_REWARDS                          = 0x3193, // new value
    CMSG_REQUEST_RAID_INFO                            = 0x36C4, // new value
    CMSG_REQUEST_RATED_BATTLEFIELD_INFO               = 0x35E3, //
    CMSG_REQUEST_RESEARCH_HISTORY                     = 0x3167, //
    CMSG_REQUEST_STABLED_PETS                         = 0x3494,
    CMSG_REQUEST_VEHICLE_EXIT                         = 0x322E, // new value
    CMSG_REQUEST_VEHICLE_NEXT_SEAT                    = 0x3230, // new value
    CMSG_REQUEST_VEHICLE_PREV_SEAT                    = 0x322F, // new value
    CMSG_REQUEST_VEHICLE_SWITCH_SEAT                  = 0x3231, // new value
    CMSG_REQUEST_WORLD_QUEST_UPDATE                   = 0x333A, // new value
    CMSG_REQUEST_WOW_TOKEN_MARKET_PRICE               = 0x36E3, // new value
    CMSG_RESET_CHALLENGE_MODE                         = 0x31FB,
    CMSG_RESET_CHALLENGE_MODE_CHEAT                   = 0x31FC,
    CMSG_RESET_INSTANCES                              = 0x3666, // new value
    CMSG_RESURRECT_RESPONSE                           = 0x3682, // new value
    CMSG_REVERT_MONUMENT_APPEARANCE                   = 0x32F5,
    CMSG_RIDE_VEHICLE_INTERACT                        = 0x3232, // new value
    CMSG_SAVE_CUF_PROFILES                            = 0x318D, // new value
    CMSG_SAVE_EQUIPMENT_SET                           = 0x350F,
    CMSG_SAVE_GUILD_EMBLEM                            = 0x329C, // new value
    CMSG_SCENE_PLAYBACK_CANCELED                      = 0x3219, // new value
    CMSG_SCENE_PLAYBACK_COMPLETE                      = 0x3218, // new value
    CMSG_SCENE_TRIGGER_EVENT                          = 0x3217,
    CMSG_SELF_RES                                     = 0x3535,
    CMSG_SELL_ITEM                                    = 0x34A5,
    CMSG_SELL_WOW_TOKEN_CONFIRM                       = 0x36E5, // new value
    CMSG_SELL_WOW_TOKEN_START                         = 0x36E4, // new value
    CMSG_SEND_CONTACT_LIST                            = 0x36CB, // new value
    CMSG_SEND_MAIL                                    = 0x35FA, //
    CMSG_SEND_SOR_REQUEST_VIA_ADDRESS                 = 0x3620, //
    CMSG_SEND_TEXT_EMOTE                              = 0x348A, //
    CMSG_SET_ACHIEVEMENTS_HIDDEN                      = 0x321F, // new value
    CMSG_SET_ACTION_BAR_TOGGLES                       = 0x3536, //
    //CMSG_SET_ACTION_BUTTON                            = 0x363F, // not exist in 1.13
    CMSG_SET_ACTIVE_MOVER                             = 0x3A37, //
    CMSG_SET_ADVANCED_COMBAT_LOGGING                  = 0x32A8, // new value
    CMSG_SET_ASSISTANT_LEADER                         = 0x364E, // new value
    CMSG_SET_BACKPACK_AUTOSORT_DISABLED               = 0x3317, // new value
    CMSG_SET_BANK_AUTOSORT_DISABLED                   = 0x3318, // new value
    CMSG_SET_BANK_BAG_SLOT_FLAG                       = 0x3316, // new value
    CMSG_SET_CONTACT_NOTES                            = 0x36CE, // new value
    CMSG_SET_CURRENCY_FLAGS                           = 0x316C, // new value
    CMSG_SET_DIFFICULTY_ID                            = 0x321B, // new value
    CMSG_SET_DUNGEON_DIFFICULTY                       = 0x3680, // new value
    ...
    CMSG_SET_INSERT_ITEMS_LEFT_TO_RIGHT               = 0x331A, // new value
    CMSG_SET_LFG_BONUS_FACTION_ID                     = 0x3297, // new value
    CMSG_SET_LOOT_METHOD                              = 0x3647, // new value
    CMSG_SET_LOOT_SPECIALIZATION                      = 0x3543,
    CMSG_SET_PARTY_ASSIGNMENT                         = 0x3650, // new value
    CMSG_SET_PARTY_LEADER                             = 0x3649, // new value
    CMSG_SET_PLAYER_DECLINED_NAMES                    = 0x3688, // new value
    CMSG_SET_PREFERRED_CEMETERY                       = 0x3178, // new value
    CMSG_SET_PVP                                      = 0x32A0, // new value
    CMSG_SET_RAID_DIFFICULTY                          = 0x36D8, // new value
    CMSG_SET_ROLE                                     = 0x35D9, //
    CMSG_SET_SAVED_INSTANCE_EXTEND                    = 0x3686, // new value
    CMSG_SET_SELECTION                                = 0x352C,
    CMSG_SET_SHEATHED                                 = 0x348B, //
    CMSG_SET_SORT_BAGS_RIGHT_TO_LEFT                  = 0x3319, // new value
    CMSG_SET_TAXI_BENCHMARK_MODE                      = 0x34F7,
    CMSG_SET_TITLE                                    = 0x3274, // new value
    ...
    CMSG_SILENCE_PARTY_TALKER                         = 0x3651, // new value
    CMSG_SOCKET_GEMS                                  = 0x34EF,
    CMSG_SORT_BAGS                                    = 0x331B, // new value
    CMSG_SORT_BANK_BAGS                               = 0x331C, // new value
    CMSG_SORT_REAGENT_BANK_BAGS                       = 0x331D, // new value
    CMSG_SPELL_CLICK                                  = 0x3498,
    CMSG_SPIRIT_HEALER_ACTIVATE                       = 0x34B2,
    CMSG_SPLIT_ITEM                                   = 0x399E, //
    CMSG_STAND_STATE_CHANGE                           = 0x318B, // new value
    CMSG_START_CHALLENGE_MODE                         = 0x354E, //
    CMSG_START_SPECTATOR_WAR_GAME                     = 0x35DF, //
    CMSG_START_WAR_GAME                               = 0x35DE, //
    CMSG_SUMMON_RESPONSE                              = 0x3668, // new value 1.13
    CMSG_SUPPORT_TICKET_SUBMIT_BUG                    = 0x3644, // new value 1.13
    CMSG_SUPPORT_TICKET_SUBMIT_COMPLAINT              = 0x3643, // new value 1.13
    CMSG_SUPPORT_TICKET_SUBMIT_SUGGESTION             = 0x3645, // new value 1.13
    CMSG_SURRENDER_ARENA                              = 0x3175, // new value
    CMSG_SUSPEND_COMMS_ACK                            = 0x3764, //
    CMSG_SUSPEND_TOKEN_RESPONSE                       = 0x376A, //
    CMSG_SWAP_INV_ITEM                                = 0x399D, //
    CMSG_SWAP_ITEM                                    = 0x399C, //
    CMSG_SWAP_SUB_GROUPS                              = 0x364C, // new value
    CMSG_SWAP_VOID_ITEM                               = 0x319F,
    CMSG_TABARD_VENDOR_ACTIVATE                       = 0x329D, // new value
    ...
    CMSG_TOGGLE_DIFFICULTY                            = 0x3655, // new value 1.13
    CMSG_TOGGLE_PVP                                   = 0x329F, // new value
    CMSG_TOTEM_DESTROYED                              = 0x34FE,
    CMSG_TRAINER_BUY_SPELL                            = 0x34B1,
    CMSG_TRAINER_LIST                                 = 0x34B0,
    CMSG_TRANSMOGRIFY_ITEMS                           = 0x3195, // new value
    CMSG_TURN_IN_PETITION                             = 0x3539,
    CMSG_TUTORIAL                                     = 0x36D9, // new value
    CMSG_TWITTER_CHECK_STATUS                         = 0x312A,
    CMSG_TWITTER_CONNECT                              = 0x3127, //
    CMSG_TWITTER_DISCONNECT                           = 0x312B, //
    CMSG_TWITTER_POST                                 = 0x331F, // new value
    CMSG_UI_TIME_REQUEST                              = 0x3698, // new value
    CMSG_UNACCEPT_TRADE                               = 0x315B, //
    CMSG_UNDELETE_CHARACTER                           = 0x36DB, // new value
    CMSG_UNLEARN_SKILL                                = 0x34E9,
    CMSG_UNLEARN_SPECIALIZATION                       = 0x31A0,
    CMSG_UNLOCK_VOID_STORAGE                          = 0x319F, // new value
    CMSG_UPDATE_ACCOUNT_DATA                          = 0x3694, // new value
    CMSG_UPDATE_AREA_TRIGGER_VISUAL                   = 0x3293, // new value
    CMSG_UPDATE_CLIENT_SETTINGS                       = 0x3662, // new value
    CMSG_UPDATE_MISSILE_TRAJECTORY                    = 0x3A3E, //
    CMSG_UPDATE_RAID_TARGET                           = 0x364F, // new value
    CMSG_UPDATE_SPELL_VISUAL                          = 0x3292, // new value
    CMSG_UPDATE_VAS_PURCHASE_STATES                   = 0x36F1, // new value
    CMSG_UPDATE_WOW_TOKEN_AUCTIONABLE_LIST            = 0x36EC,
    CMSG_UPDATE_WOW_TOKEN_COUNT                       = 0x36E2, // new value
    CMSG_UPGRADE_GARRISON                             = 0x32AD,
    CMSG_UPGRADE_ITEM                                 = 0x3220, // new value
    CMSG_USED_FOLLOW                                  = 0x3188, // new value
    CMSG_USE_CRITTER_ITEM                             = 0x3238, // new value
    CMSG_USE_EQUIPMENT_SET                            = 0x3995, //
    CMSG_USE_ITEM                                     = 0x328D, // new value
    CMSG_USE_TOY                                      = 0x328F, // new value
    CMSG_VIOLENCE_LEVEL                               = 0x3186, // new value
    CMSG_VOID_STORAGE_TRANSFER                        = 0x31A1, // new value
    CMSG_WARDEN_DATA                                  = 0x35EC, //
    CMSG_WHO                                          = 0x367F, // new value
    CMSG_WHO_IS                                       = 0x367E, // new value
    CMSG_WORLD_PORT_RESPONSE                          = 0x35F9, //
    CMSG_WRAP_ITEM                                    = 0x3994, //

    CMSG_SET_ACTION_BUTTON                            = 0x355C, // TODO TEST

    //Unknown Opcodes 1.13.0 NEW
    //CMSG_UNK_UI_BUTTONS                               = 0x355C, // when i move spell into bar it call this opcode
    CMSG_UNK_OPCODE1                                  = 0x355D,
    CMSG_UNK_OPCODE2                                  = 0x355E,
    CMSG_UNK_OPCODE3                                  = 0x355F,
    CMSG_UNK_OPCODE4                                  = 0x3168,
    CMSG_UNK_OPCODE5                                  = 0x3169,
    CMSG_UNK_OPCODE6                                  = 0x316A,
    CMSG_UNK_OPCODE7                                  = 0x316B,
    CMSG_UNK_OPCODE8                                  = 0x354D,

    // Not exist Opcodes 1.13.0
    CMSG_QUERY_SCENARIO_POI                           = 0xBADD, // Not exist in 1.13
    CMSG_QUEST_POI_QUERY                              = 0xBADD, // Not exist in 1.13
    CMSG_SHOW_TRADE_SKILL                             = 0xBADD, // Not exist 1.13
    CMSG_SET_PET_SLOT                                 = 0xBADD, // Not exist in 1.13
    CMSG_TRADE_SKILL_SET_FAVORITE                     = 0xBADD, // not exist in 1.13
...
enum OpcodeServer : uint16
{
    ...
    SMSG_ACCOUNT_CRITERIA_UPDATE                      = 0x2651, // new value
    SMSG_ACCOUNT_DATA_TIMES                           = 0x2743, // new value
    SMSG_ACCOUNT_MOUNT_UPDATE                         = 0x25C3,
    SMSG_ACCOUNT_TOYS_UPDATE                          = 0x25C4,
    SMSG_ACHIEVEMENT_DELETED                          = 0x2719, // new value
    SMSG_ACHIEVEMENT_EARNED                           = 0x265F, // new value
    SMSG_ACTIVATE_TAXI_REPLY                          = 0x26A5, // new value
    ...
    SMSG_AI_REACTION                                  = 0x26DE, // new value
    ...
    SMSG_AREA_TRIGGER_NO_CORPSE                       = 0x274F, // new value
    SMSG_AREA_TRIGGER_RE_PATH                         = 0x263F,
    SMSG_AREA_TRIGGER_RE_SHAPE                        = 0x263C,
    SMSG_ARENA_CROWD_CONTROL_SPELLS                   = 0x264E,
    SMSG_ARENA_ERROR                                  = 0x270C, // new value
    SMSG_ARENA_PREP_OPPONENT_SPECIALIZATIONS          = 0x2664, // new value
    ...
    SMSG_ATTACKER_STATE_UPDATE                        = 0x27C9, // new value
    SMSG_ATTACK_START                                 = 0x266C, // new value
    SMSG_ATTACK_STOP                                  = 0x266D, // new value
    SMSG_ATTACK_SWING_ERROR                           = 0x272D, // new value
    SMSG_ATTACK_SWING_LANDED_LOG                      = 0x272E, // new value
    SMSG_AUCTION_CLOSED_NOTIFICATION                  = 0x2728,
    SMSG_AUCTION_COMMAND_RESULT                       = 0x2725,
    SMSG_AUCTION_HELLO_RESPONSE                       = 0x271E, // new value
    ...
    SMSG_BAN_REASON                                   = 0x26B1, // new value
    ...
    SMSG_BATTLENET_NOTIFICATION                       = 0x283B, // new value
    SMSG_BATTLENET_REALM_LIST_TICKET                  = 0x283D, // new value
    SMSG_BATTLENET_RESPONSE                           = 0x283A, // new value
    SMSG_BATTLENET_SET_SESSION_STATE                  = 0x283C, // new value
    ...
    SMSG_BATTLE_PET_CAGE_DATE_ERROR                   = 0x269F, // new value
    SMSG_BATTLE_PET_DELETED                           = 0x2606,
    SMSG_BATTLE_PET_ERROR                             = 0x2654, // new value
    ...
    SMSG_BONUS_ROLL_EMPTY                             = 0x2661, // new value
    SMSG_BOSS_KILL_CREDIT                             = 0x27C0,
    SMSG_BREAK_TARGET                                 = 0x266C, //todo
    SMSG_BUY_FAILED                                   = 0x26F1,
    SMSG_BUY_SUCCEEDED                                = 0x26F0,
    SMSG_CACHE_INFO                                   = 0x273D, // new value
    SMSG_CACHE_VERSION                                = 0x273C, // new value
    ...
    SMSG_CALENDAR_SEND_CALENDAR                       = 0x26B3, // new value
    SMSG_CALENDAR_SEND_EVENT                          = 0x26B4, // new value
    SMSG_CALENDAR_SEND_NUM_PENDING                    = 0x26C5,
    SMSG_CAMERA_EFFECT                                = 0x2767,
    SMSG_CANCEL_AUTO_REPEAT                           = 0x270D, // new value
    ...
    SMSG_CHANGE_PLAYER_DIFFICULTY_RESULT              = 0x272F, // new value
    SMSG_CHANNEL_LIST                                 = 0x2BC3, //
    SMSG_CHANNEL_NOTIFY                               = 0x2BC0, //
    SMSG_CHANNEL_NOTIFY_JOINED                        = 0x2BC1, //
    SMSG_CHANNEL_NOTIFY_LEFT                          = 0x2BC2, //
    SMSG_CHARACTER_CLASS_TRIAL_CREATE                 = 0x27FE, // new value
    SMSG_CHARACTER_INVENTORY_OVERFLOW_WARNING         = 0x285B, // new value
    SMSG_CHARACTER_ITEM_FIXUP                         = 0x284C, // new value
    SMSG_CHARACTER_LOGIN_FAILED                       = 0x273E, // new value
    SMSG_CHARACTER_OBJECT_TEST_RESPONSE               = 0x2780, // new value
    SMSG_CHARACTER_RENAME_RESULT                      = 0x27A5,
    SMSG_CHARACTER_UPGRADE_COMPLETE                   = 0x27FD, // new value
    SMSG_CHARACTER_UPGRADE_QUEUED                     = 0x27FC, // new value
    SMSG_CHARACTER_UPGRADE_SPELL_TIER_SET             = 0x25F4,
    SMSG_CHARACTER_UPGRADE_STARTED                    = 0x27FB, // new value
    SMSG_CHARACTER_UPGRADE_UNREVOKE_RESULT            = 0x27FF, // new value
    SMSG_CHAR_CUSTOMIZE                               = 0x2714, // new value
    SMSG_CHAR_CUSTOMIZE_FAILED                        = 0x2713, // new value
    ...
    SMSG_COMBAT_EVENT_FAILED                          = 0x266E, // new value
    SMSG_COMMENTATOR_MAP_INFO                         = 0x2740, // new value
    SMSG_COMMENTATOR_PLAYER_INFO                      = 0x2741, // new value
    SMSG_COMMENTATOR_STATE_CHANGED                    = 0x273F, // new value
    ...
    SMSG_FISH_ESCAPED                                 = 0x26F8, // new value
    SMSG_FISH_NOT_HOOKED                              = 0x26F7, // new value
    SMSG_FLIGHT_SPLINE_SYNC                           = 0x2DF7,
    SMSG_FORCED_DEATH_UPDATE                          = 0x2705, // new value
    SMSG_FORCE_ANIM                                   = 0x278E, // new value
    SMSG_FORCE_OBJECT_RELINK                          = 0x2666, // new value
    ...
    SMSG_GAME_OBJECT_RESET_STATE                      = 0x2757, // new value
    SMSG_GAME_OBJECT_SET_STATE                        = 0x2839, // new value
    SMSG_GAME_OBJECT_UI_ACTION                        = 0x2754, // new value
    SMSG_GAME_SPEED_SET                               = 0x26A9, //
    SMSG_GAME_TIME_SET                                = 0x2745, // new value
    SMSG_GAME_TIME_UPDATE                             = 0x2744, // new value
    //not used garr opcodes
    ...
    SMSG_GET_ACCOUNT_CHARACTER_LIST_RESULT            = 0x279D, // new value
    SMSG_GET_DISPLAYED_TROPHY_LIST_RESPONSE           = 0x2928,
    SMSG_GET_GARRISON_INFO_RESULT                     = 0x28F0,
    SMSG_GET_SHIPMENTS_OF_TYPE_RESPONSE               = 0x27D9, // new value
    SMSG_GET_SHIPMENT_INFO_RESPONSE                   = 0x27D5, // new value
    ...
    SMSG_GOD_MODE                                     = 0x2732, // new value
    SMSG_GOSSIP_COMPLETE                              = 0x2A96, //todo
    SMSG_GOSSIP_MESSAGE                               = 0x2A97, //todo
    SMSG_GOSSIP_POI                                   = 0x27D2, // new value
    SMSG_GROUP_ACTION_THROTTLED                       = 0x259C, //
    SMSG_GROUP_DECLINE                                = 0x27CD, // new value
    SMSG_GROUP_DESTROYED                              = 0x27CF, // new value
    SMSG_GROUP_INVITE_CONFIRMATION                    = 0x284D, // new value
    SMSG_GROUP_NEW_LEADER                             = 0x2649,
    SMSG_GROUP_UNINVITE                               = 0x27CE, // new value
    ...
    SMSG_HEALTH_UPDATE                                = 0x26FB, //new value
    SMSG_HOTFIX_MESSAGE                               = 0x25A2, //
    SMSG_HOTFIX_RESPONSE                              = 0x25A3, //
    SMSG_INITIALIZE_FACTIONS                          = 0x275F, // new value
    SMSG_INITIAL_SETUP                                = 0x257F, //
    SMSG_INIT_WORLD_STATES                            = 0x2785, // new value
    SMSG_INSPECT_HONOR_STATS                          = 0x25B2,
    SMSG_INSPECT_PVP                                  = 0x275B, // new value
    ...
    SMSG_INSTANCE_GROUP_SIZE_CHANGED                  = 0x2730, // new value
    SMSG_INSTANCE_INFO                                = 0x264F, // new value
    SMSG_INSTANCE_RESET                               = 0x26AE,
    SMSG_INSTANCE_RESET_FAILED                        = 0x26B0,
    SMSG_INSTANCE_SAVE_CREATED                        = 0x27BD,
    SMSG_INVALIDATE_PAGE_TEXT                         = 0x2700, // new value
    SMSG_INVALIDATE_PLAYER                            = 0x26D1, // new value
    SMSG_INVALID_PROMOTION_CODE                       = 0x278F, // new value
    SMSG_INVENTORY_CHANGE_FAILURE                     = 0x275D, // new value
    SMSG_IS_QUEST_COMPLETE_RESPONSE                   = 0x2A83,
    SMSG_ITEM_CHANGED                                 = 0x271B, // new value
    SMSG_ITEM_COOLDOWN                                = 0x2805, // new value
    SMSG_ITEM_ENCHANT_TIME_UPDATE                     = 0x2791, // new value
    SMSG_ITEM_EXPIRE_PURCHASE_REFUND                  = 0x25B1, //
    SMSG_ITEM_PURCHASE_REFUND_RESULT                  = 0x25AF, //
    SMSG_ITEM_PUSH_RESULT                             = 0x2636, // new value
    SMSG_ITEM_TIME_UPDATE                             = 0x2790, // new value
    SMSG_KICK_REASON                                  = 0x2827, // new value
    SMSG_LEARNED_SPELLS                               = 0x2C4D,
    SMSG_LEARN_PVP_TALENTS_FAILED                     = 0x25EA,
    SMSG_LEARN_TALENTS_FAILED                         = 0x25E9,
    SMSG_LEVEL_UPDATE                                 = 0x2587,
    SMSG_LEVEL_UP_INFO                                = 0x271A, // new value
    ...
    SMSG_LIVE_REGION_GET_ACCOUNT_CHARACTER_LIST_RESULT = 0x279E, // new value
    SMSG_LOAD_CUF_PROFILES                            = 0x25CE,
    SMSG_LOAD_EQUIPMENT_SET                           = 0x2747, // new value
    SMSG_LOAD_SELECTED_TROPHY_RESULT                  = 0xBADD, //temp due indentical id with ubate_object
    SMSG_LOGIN_SET_TIME_SPEED                         = 0x2746, // new value
    SMSG_LOGIN_VERIFY_WORLD                           = 0x25AC, //
    SMSG_LOGOUT_CANCEL_ACK                            = 0x26AD, // new value
    SMSG_LOGOUT_COMPLETE                              = 0x26AC, // new value
    SMSG_LOGOUT_RESPONSE                              = 0x26AB, // new value
    SMSG_LOG_XP_GAIN                                  = 0x2716, // new value
    SMSG_LOOT_ALL_PASSED                              = 0x2634, // new value
    ...
    SMSG_LOOT_ROLL_WON                                = 0x2635, // new value
    SMSG_LOSS_OF_CONTROL_AURA_UPDATE                  = 0x2695,
    SMSG_MAIL_COMMAND_RESULT                          = 0x2658,
    SMSG_MAIL_LIST_RESULT                             = 0x2792, // new value
    ...
    SMSG_MINIMAP_PING                                 = 0x26F6, // new value
    ...
    SMSG_MODIFY_PARTY_RANGE                           = 0xBADD, // temp disabled id due duplicate
    SMSG_MOTD                                         = 0x2BAF, //
    SMSG_MOUNT_RESULT                                 = 0x257A,
    //todo check all movement
    ...
    SMSG_NEW_TAXI_PATH                                = 0x26A6, // new value
    ...
    SMSG_PET_GOD_MODE                                 = 0x26A3, // new value
    SMSG_PET_GUIDS                                    = 0x2741, // new value
    ...
    SMSG_PLAYED_TIME                                  = 0x2707, // new value
    ...
    SMSG_PLAY_ONE_SHOT_ANIM_KIT                       = 0x276C, // new value
    SMSG_PLAY_ORPHAN_SPELL_VISUAL                     = 0x2C47,
    SMSG_PLAY_SCENE                                   = 0x2652, // new value
    SMSG_PLAY_SOUND                                   = 0x27AA,
    SMSG_PLAY_SPEAKERBOT_SOUND                        = 0x27AD,
    SMSG_PLAY_SPELL_VISUAL                            = 0x2C45,
    SMSG_PLAY_SPELL_VISUAL_KIT                        = 0x2C49,
    SMSG_PLAY_TIME_WARNING                            = 0x2734, // new value
    SMSG_PONG                                         = 0x304E,
    SMSG_POWER_UPDATE                                 = 0x26FC, // new value
    SMSG_PRESTIGE_AND_HONOR_INVOLUNTARILY_CHANGED     = 0x2752, // new value
    ...
    SMSG_PVP_CREDIT                                   = 0x2711, // new value
    SMSG_PVP_LOG_DATA                                 = 0x25B3,
    SMSG_PVP_OPTIONS_ENABLED                          = 0x25B6,
    SMSG_PVP_SEASON                                   = 0x25D3,
    SMSG_QUERY_BATTLE_PET_NAME_RESPONSE               = 0x2702, // new value
    SMSG_QUERY_CREATURE_RESPONSE                      = 0x26F9, // new value
    SMSG_QUERY_GAME_OBJECT_RESPONSE                   = 0x26FA, // new value
    SMSG_QUERY_GARRISON_CREATURE_NAME_RESPONSE        = 0x292B,
    SMSG_QUERY_GUILD_INFO_RESPONSE                    = 0x29E5,
    SMSG_QUERY_ITEM_TEXT_RESPONSE                     = 0x2804, // new value
    SMSG_QUERY_NPC_TEXT_RESPONSE                      = 0x26FD, // new value
    SMSG_QUERY_PAGE_TEXT_RESPONSE                     = 0x26FF,
    SMSG_QUERY_PETITION_RESPONSE                      = 0x2703, // new value
    SMSG_QUERY_PET_NAME_RESPONSE                      = 0x2701, // new value
    SMSG_QUERY_PLAYER_NAME_RESPONSE                   = 0x26FE, // new value
    SMSG_QUERY_QUEST_INFO_RESPONSE                    = 0x2A95, //
    SMSG_QUERY_QUEST_REWARD_RESPONSE                  = 0x283E, // new value
    SMSG_QUERY_TIME_RESPONSE                          = 0x2715, // new value
    ...
    SMSG_READY_CHECK_STARTED                          = 0x260B, // new value
    SMSG_READ_ITEM_RESULT_FAILED                      = 0x27E5, // new value
    SMSG_READ_ITEM_RESULT_OK                          = 0x27DB, // new value
    SMSG_REALM_LOOKUP_INFORMATION                     = 0x280A, // new value
    SMSG_REALM_QUERY_RESPONSE                         = 0x26E4, // new value
    SMSG_RECRUIT_A_FRIEND_RESPONSE                    = 0x27C9,
    SMSG_REFER_A_FRIEND_EXPIRED                       = 0x275C, // new value
    ...
    SMSG_REQUEST_ADDON_LIST                           = 0x265E, // new value
    ...
    SMSG_RESET_RANGED_COMBAT_TIMER                    = 0x270E, // new value
    ...
    SMSG_RESYNC_RUNES                                 = 0x2737, // new value
    ...
    SMSG_SCENE_OBJECT_EVENT                           = 0x25F6, // new value
    ...
    SMSG_SCENE_OBJECT_PET_BATTLE_INITIAL_UPDATE       = 0x25F7, // new value
    ...
    SMSG_SERVER_TIME                                  = 0x26AA, // new value
    SMSG_SETUP_CURRENCY                               = 0x2572, //
    SMSG_SETUP_RESEARCH_HISTORY                       = 0x2584,
    SMSG_SET_AI_ANIM_KIT                              = 0x276B, // new value
    SMSG_SET_ALL_TASK_PROGRESS                        = 0x27CB, // new value
    SMSG_SET_ANIM_TIER                                = 0x2775,
    SMSG_SET_CURRENCY                                 = 0x2573, //
    SMSG_SET_DF_FAST_LAUNCH_RESULT                    = 0x2A2E,
    SMSG_SET_DUNGEON_DIFFICULTY                       = 0x26CD,
    SMSG_SET_FACTION_AT_WAR                           = 0x2736, // new value
    SMSG_SET_FACTION_NOT_VISIBLE                      = 0x2766, // new value
    SMSG_SET_FACTION_STANDING                         = 0x2767, // new value
    SMSG_SET_FACTION_VISIBLE                          = 0x2765, // new value
    SMSG_SET_FLAT_SPELL_MODIFIER                      = 0x2C36,
    SMSG_SET_FORCED_REACTIONS                         = 0x2756, // new value
    SMSG_SET_ITEM_PURCHASE_DATA                       = 0x25B0, //
    SMSG_SET_LOOT_METHOD_FAILED                       = 0x2810, // new value
    SMSG_SET_MAX_WEEKLY_QUANTITY                      = 0x25B7,
    SMSG_SET_MELEE_ANIM_KIT                           = 0x276E, // new value
    SMSG_SET_MOVEMENT_ANIM_KIT                        = 0x276D, // new value
    SMSG_SET_PCT_SPELL_MODIFIER                       = 0x2C37,
    SMSG_SET_PET_SPECIALIZATION                       = 0x2641,
    SMSG_SET_PLAYER_DECLINED_NAMES_RESULT             = 0x2706, // new value
    SMSG_SET_PLAY_HOVER_ANIM                          = 0x25CC,
    SMSG_SET_PROFICIENCY                              = 0x2776,
    SMSG_SET_SPELL_CHARGES                            = 0x2C29,
    SMSG_SET_TASK_COMPLETE                            = 0x27CC, // new value
    SMSG_SET_TIME_ZONE_INFORMATION                    = 0x269E, // new value
    SMSG_SET_VEHICLE_REC_ID                           = 0x272F,
    SMSG_SHOW_ADVENTURE_MAP                           = 0x2835,
    SMSG_SHOW_BANK                                    = 0x26A7, // new value
    SMSG_SHOW_MAILBOX                                 = 0x27ED,
    SMSG_SHOW_NEUTRAL_PLAYER_FACTION_SELECT_UI        = 0x25F0,
    SMSG_SHOW_TAXI_NODES                              = 0x26F5, // new value
    SMSG_SHOW_TRADE_SKILL_RESPONSE                    = 0x27B2,
    SMSG_SOCKET_GEMS                                  = 0x2762, // new value
    SMSG_SOCKET_GEMS_FAILURE                          = 0x2763, // new value
    SMSG_SORT_BAGS_RESULT                             = 0x281E, // new value
    SMSG_SOR_START_EXPERIENCE_INCOMPLETE              = 0x25F2,
    SMSG_SPECIALIZATION_CHANGED                       = 0x25EC,
    SMSG_SPECIAL_MOUNT_ANIM                           = 0x26C8,
    SMSG_SPEC_INVOLUNTARILY_CHANGED                   = 0x2751, // new value
    ...
    SMSG_SPIRIT_HEALER_CONFIRM                        = 0x274E, // new value
    SMSG_STAND_STATE_UPDATE                           = 0x2755, // new value
    SMSG_START_ELAPSED_TIMER                          = 0x261A,
    SMSG_START_ELAPSED_TIMERS                         = 0x261B, // new value
    ...
    SMSG_SUMMON_REQUEST                               = 0x275A, // new value
    SMSG_SUPERCEDED_SPELLS                            = 0x2C4C,
    SMSG_SUSPEND_COMMS                                = 0x304A,
    SMSG_SUSPEND_TOKEN                                = 0x25BD,
    SMSG_TALENTS_INVOLUNTARILY_RESET                  = 0x2750, // new value
    SMSG_TAXI_NODE_STATUS                             = 0x26A4, // new value
    SMSG_TEXT_EMOTE                                   = 0x26A2, // new value
    SMSG_TIME_ADJUSTMENT                              = 0x2DA1,
    SMSG_TIME_SYNC_REQUEST                            = 0x2DA0,
    SMSG_TITLE_EARNED                                 = 0x2709, // new value
    SMSG_TITLE_LOST                                   = 0x270A, // new value
    SMSG_TOTEM_CREATED                                = 0x26F2,
    SMSG_TOTEM_MOVED                                  = 0x26F3,
    SMSG_TRADE_STATUS                                 = 0x2581,
    SMSG_TRADE_UPDATED                                = 0x2580,
    SMSG_TRAINER_BUY_FAILED                           = 0x2710, // new value
    SMSG_TRAINER_LIST                                 = 0x270F, // new value
    SMSG_TRANSFER_ABORTED                             = 0x273A, // new value
    SMSG_TRANSFER_PENDING                             = 0x25E5, //
    SMSG_TRANSMOG_COLLECTION_UPDATE                   = 0x25C6,
    SMSG_TRANSMOG_SET_COLLECTION_UPDATE               = 0x25C7,
    SMSG_TRIGGER_CINEMATIC                            = 0x2808, // new value
    SMSG_TRIGGER_MOVIE                                = 0x26F4,
    SMSG_TURN_IN_PETITION_RESULT                      = 0x2791,
    SMSG_TUTORIAL_FLAGS                               = 0x27FA, // new value
    SMSG_TUTORIAL_HIGHLIGHT_SPELL                     = 0x2838, // new value
    SMSG_TUTORIAL_UNHIGHLIGHT_SPELL                   = 0x2837, // new value
    SMSG_TWITTER_STATUS                               = 0x2FFD,
    SMSG_UI_TIME                                      = 0x274D, // new value
    SMSG_UNDELETE_CHARACTER_RESPONSE                  = 0x280B, // new value
    SMSG_UNDELETE_COOLDOWN_STATUS_RESPONSE            = 0x280C, // new value
    SMSG_UNLEARNED_SPELLS                             = 0x2C4E,
    SMSG_UPDATE_ACCOUNT_DATA                          = 0x2742, // new value
    SMSG_UPDATE_CELESTIAL_BODY                        = 0x2856,  // new value / old is - 0x285E
    SMSG_UPDATE_CHARACTER_FLAGS                       = 0x2800, // new value
    SMSG_UPDATE_EXPANSION_LEVEL                       = 0x2662, // new value
    SMSG_UPDATE_GAME_TIME_STATE                       = 0x285D, // new value 
    SMSG_UPDATE_INSTANCE_OWNERSHIP                    = 0x26D0,
    SMSG_UPDATE_LAST_INSTANCE                         = 0x26B1,
    SMSG_UPDATE_OBJECT                                = 0x2809, // new value
    SMSG_UPDATE_TALENT_DATA                           = 0x25EB, //
    SMSG_UPDATE_TASK_PROGRESS                         = 0x27CA, // new value
    SMSG_UPDATE_WEEKLY_SPELL_USAGE                    = 0x2C19,
    SMSG_UPDATE_WORLD_STATE                           = 0x2786, // new value
    SMSG_USERLIST_ADD                                 = 0x2BB9, //
    SMSG_USERLIST_REMOVE                              = 0x2BBA, //
    SMSG_USERLIST_UPDATE                              = 0x2BBB, //
    SMSG_USE_EQUIPMENT_SET_RESULT                     = 0x278C, // new value
    ...
    SMSG_WEATHER                                      = 0x26CE, // new value
    SMSG_WEEKLY_SPELL_USAGE                           = 0x2C18,
    SMSG_WHO                                          = 0x2BAE, //
    SMSG_WHO_IS                                       = 0x26CD, // new value
    SMSG_WORLD_QUEST_UPDATE                           = 0x283F, // new value
    ...
    SMSG_WOW_TOKEN_UPDATE_AUCTIONABLE_LIST_RESPONSE   = 0x281D, // new value
    SMSG_XP_GAIN_ABORTED                              = 0x25E0,
    SMSG_XP_GAIN_ENABLED                              = 0x27EA, // new value
    ...
    // CMSG Opcodes that don't exist in 1.13
    SMSG_ARTIFACT_XP_GAIN                             = 0xBADD, // not exist in 1.13 ? todo once more check
    SMSG_DESTRUCTIBLE_BUILDING_DAMAGE                 = 0xBADD, // not exist in 1.13
    SMSG_HIGHEST_THREAT_UPDATE                        = 0xBADD, // not exist in 1.13
    SMSG_THREAT_CLEAR                                 = 0xBADD, // not exist in 1.13
    SMSG_THREAT_REMOVE                                = 0xBADD, // not exist in 1.13
    SMSG_THREAT_UPDATE                                = 0xBADD, // not exist in 1.13
    SMSG_WORLD_TEXT                                   = 0xBADD, // Not exist in 1.13
    SMSG_UPDATE_ACTION_BUTTONS                        = 0xBADD, // not found in 1.13 ? todo recheck
