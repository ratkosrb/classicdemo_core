...
struct ItemSparseLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static DB2FieldMeta const fields[] =
        {
            ...
            { true, FT_INT, "Flags3" },
            { true, FT_INT, "Flags4" },
            { true, FT_FLOAT, "PriceRandomValue" },
            { true, FT_FLOAT, "PriceVariance" },
            ...
            { true, FT_FLOAT, "StatPercentageOfSocket1" },
            { true, FT_FLOAT, "StatPercentageOfSocket2" },
            { true, FT_FLOAT, "StatPercentageOfSocket3" },
            { true, FT_FLOAT, "StatPercentageOfSocket4" },
            { true, FT_FLOAT, "StatPercentageOfSocket5" },
            { true, FT_FLOAT, "StatPercentageOfSocket6" },
            { true, FT_FLOAT, "StatPercentageOfSocket7" },
            { true, FT_FLOAT, "StatPercentageOfSocket8" },
            { true, FT_FLOAT, "StatPercentageOfSocket9" },
            { true, FT_FLOAT, "StatPercentageOfSocket10" },
            { true, FT_FLOAT, "ItemRange" },
            { false, FT_INT, "BagFamily" },
            { true, FT_FLOAT, "QualityModifier" },
            { false, FT_INT, "DurationInInventory" },
            { true, FT_FLOAT, "DmgVariance" },
...
struct TalentLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static DB2FieldMeta const fields[] =
        {
            ...
            { false, FT_INT, "SpellRank1" },
            { false, FT_INT, "SpellRank2" },
            { false, FT_INT, "SpellRank3" },
            { false, FT_INT, "SpellRank4" },
            { false, FT_INT, "SpellRank5" },
            { false, FT_INT, "SpellRank6" },
            { false, FT_INT, "SpellRank7" },
            { false, FT_INT, "SpellRank8" },
            { false, FT_INT, "SpellRank9" },
            { true, FT_INT, "RequiredSpellID" },
            { false, FT_SHORT, "SpecID" },
            { false, FT_SHORT, "TabID" },
            { false, FT_SHORT, "PrereqTalent1" },
            { false, FT_SHORT, "PrereqTalent2" },
            { false, FT_SHORT, "PrereqTalent3" },
            { false, FT_SHORT, "PrereqRank1" },
            { false, FT_SHORT, "PrereqRank2" },
            { false, FT_SHORT, "PrereqRank3" },
